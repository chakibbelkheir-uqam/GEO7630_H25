...
map.on('load', function () {
    map.addSource('qt_arbres_quartier_source', {
        type: 'vector',
        tiles: ['https://cuddly-spoon-69q6q64w4rj249x4-8801.app.github.dev/public.densite_arbres_quartiers/{z}/{x}/{y}.pbf']
    });
    map.addLayer({
...
function loadWFS() {
    ...
    map.addSource('arrondissements-source', {
        ...
        data: 'https://cuddly-spoon-69q6q64w4rj249x4-9000.app.github.dev/collections/BELM24339701.arrondissements/items?limit=5000' // URL pgFeatureServ GeoJSON ! Attention il faut bien inclure la méthode qui fait la requete sans limite d'items de données
    });
